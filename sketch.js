...
let ctrls = {
    ...
    clr1: {r:0, g:255, b:205}, //color 1
    clr2:{ r:0, g:18, b:50}, //color 2
    d_range: {min: 1, max:25}, //range of sphere diameters
...
function triggerNote(note) {
    ...
    sphere.position.y = Math.ceil(Math.random() * 15);
    sphere.position.z = Math.ceil(Math.random() * 15);
...
let keynotes = [];
keynotes[68] = {name:'C', octave:'4', number:65}
keynotes[70] = {name:'D', octave:'4', number:65}
keynotes[71] = {name:'E', octave:'4', number:65}
keynotes[72] = {name:'F', octave:'4', number:65}
keynotes[74] = {name:'G', octave:'4', number:65}
keynotes[75] = {name:'A', octave:'4', number:65}
keynotes[76] = {name:'B', octave:'4', number:70}
keynotes[186] = {name:'C', octave:'5', number:70}
...
var createScene = function () {
    ...
    var camera = new BABYLON.ArcRotateCamera("Camera", 2 * Math.PI / 2, Math.PI / 4, 100, BABYLON.Vector3.Zero(), scene);
    ...
    groundTexture.vScale = groundTexture.uScale = 5.0;
